...
/** Positions confirmed "correct" (right letter, right place) across all prior
 *  guesses. Space positions are never included. Used to pre-fill the next row. */
export function confirmedCorrectPositions(
  guesses: string[],
  target: string,
): Set<number> {
